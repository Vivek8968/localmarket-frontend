    ...
    <div className="card hover:shadow-lg transition-shadow duration-300">
      <div className="relative h-48 w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
          ...
          <p className="text-white/80 text-sm">{formatDistance(shop.distance)}</p>
        </div>
      </div>
      
      <div className="p-4">
        <p className="text-gray-600 text-sm mb-4 flex items-start">
          <svg className="h-5 w-5 mr-1 text-gray-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex space-x-2">
          ...
          <button 
            ...
            className="flex items-center justify-center px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-md transition-colors"
